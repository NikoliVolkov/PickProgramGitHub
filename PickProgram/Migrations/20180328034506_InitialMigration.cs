        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LocationId = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    LocationDescription = table.Column<string>(unicode: false, maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PickLocation", x => x.LocationId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickLocationId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoice_PickLocation",
                        column: x => x.PickLocationId,
                        principalTable: "PickLocation",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Invoice_AssignedEmployeeId",
                table: "Invoice",
                column: "AssignedEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoice_PickLocationId",
                table: "Invoice",
                column: "PickLocationId");
